...
import miniplc0java.navm.NavmInstruction;
...
//        }
            ...
            // analyze
            var analyzer = new Analyser(tokenizer);
            List<NavmInstruction> instructions;
            try {
                instructions = analyzer.analyse();
            } catch (Exception e) {
                // 遇到错误不输出，直接退出
...
//java -jar ./build/libs/miniplc0java.jar -t -o output.txt /Users/apple/desktop/token.txt
